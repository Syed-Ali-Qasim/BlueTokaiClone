...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    drinkingPreference: Schema.Attribute.JSON & Schema.Attribute.Required;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    flavourProfile: Schema.Attribute.JSON & Schema.Attribute.Required;
